...
# -*- coding: utf-8 -*-
"""
Created on Tue July 25 09:13 2023
...
def getFeedback():
      try:
        # Your existing code to get the feedback
        # ...
        feedback_response = {'response': feedback}
        return jsonify(feedback_response)
      except Exception as e:
        # Handle the exception and return an error response as JSON
        error_response = {'error': str(e)}
        return jsonify(error_response), 500  # Return HTTP status code 500 for internal server error
